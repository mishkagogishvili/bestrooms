...
import ChangeCurrencyRadioBtn from "./ChangeCurrencyRadioBtn";
...
const ChangeCurrencyDrawer = ({ onOpen }) => {
  ...
  return (
    ...
    >
      <Text style={styles.changeLanguageDrawerName}>Change currency</Text>
      <ChangeCurrencyRadioBtn onSelect={handleClose} />
    </BottomSheet>
  );
};
